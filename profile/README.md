...
### [anaconda-mcp-claude-desktop-demo](https://github.com/Anaconda-Labs/anaconda-mcp-claude-desktop-demo)
...
Built on 12+ years of infrastructure that powers the Python data science world:
 
```
conda · Anaconda MCP · Anaconda.org · MetaFlow · PyScript · BeeWare · Numba · fsspec · projspec · jupyter · HoloViz Panel
```
...
We couldn't do this without our friends in the ecosystem. 
[`conda`](https://github.com/conda/conda) · [`conda-forge`](https://conda-forge.org/) · [Anaconda MCP](https://www.anaconda.com/docs/tools/anaconda-mcp-server#anaconda-mcp-server) · [Anaconda.org](https://anaconda.org) · [`MetaFlow`](https://metaflow.org/) · [`PyScript`](https://pyscript.net) · [`BeeWare`](https://beeware.org/) · [`Numba`](https://numba.pydata.org/) · [`fsspec`](https://filesystem-spec.readthedocs.io/en/latest/) · [`projspec`](https://projspec.readthedocs.io/en/latest/) · [`jupyter`](https://jupyter.org/) · [HoloViz `panel`](https://panel.holoviz.org/) 
 
 
<div align="center"><sub>Built with 🐍 by Anaconda · Powering the Python data science stack since 2012</sub></div>
